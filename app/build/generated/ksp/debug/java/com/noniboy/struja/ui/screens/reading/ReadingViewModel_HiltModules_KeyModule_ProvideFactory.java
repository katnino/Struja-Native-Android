...
public final class ReadingViewModel_HiltModules_KeyModule_ProvideFactory implements Factory<Boolean> {
  @Override
  public Boolean get() {
    return provide();
  }
  ...
  public static boolean provide() {
    return ReadingViewModel_HiltModules.KeyModule.provide();
  }
